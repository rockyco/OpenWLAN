...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "module2_coarse_cfo.autotvin.dat"
	set constFileTvOut       "module2_coarse_cfo.autotvout.dat"
	set constFileHdlTvIn     "module2_coarse_cfo.autohdltvin.dat"
	set constFileHdlTvOut    "module2_coarse_cfo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
