...
module AESL_autofifo_coarseFreqOff_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module2_coarse_cfo.autotvin_coarseFreqOff_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module2_coarse_cfo.autotvout_coarseFreqOff_out.dat";
