...
module AESL_autofifo_search_buffer_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module2_coarse_cfo.autotvin_search_buffer_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module2_coarse_cfo.autotvout_search_buffer_out.dat";
