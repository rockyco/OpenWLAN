...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.module2_coarse_cfo.autotvin_data_in.dat"
         "c.module2_coarse_cfo.autotvin_startOffset_in.dat"
         "c.module2_coarse_cfo.autotvin_num_samples.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.module2_coarse_cfo.autotvout_search_buffer_out.dat"
         "rtl.module2_coarse_cfo.autotvout_coarseFreqOff_out.dat"
         "rtl.module2_coarse_cfo.autotvout_searchBufferLen_out.dat"
         "rtl.module2_coarse_cfo.autotvout_passthrough_out.dat"
         "rtl.module2_coarse_cfo.autotvout_startOffset_fwd_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
