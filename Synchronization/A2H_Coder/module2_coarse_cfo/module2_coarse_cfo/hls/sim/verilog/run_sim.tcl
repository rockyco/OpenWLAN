...
if {[file isfile module2_coarse_cfo.autotvin.dat]} {
	file delete -force module2_coarse_cfo.autotvin.dat
}

if {[file isfile module2_coarse_cfo.autotvout.dat]} {
	file delete -force module2_coarse_cfo.autotvout.dat
}
