...
module module2_coarse_cfo_module2_coarse_cfo_Pipeline_PHASE_D (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [25:0] trunc_ln164_1_fu_363_p4;
wire   [25:0] trunc_ln164_2_fu_373_p4;
...
wire   [25:0] trunc_ln165_1_fu_411_p4;
wire   [25:0] trunc_ln165_2_fu_421_p4;
...
module2_coarse_cfo_module2_coarse_cfo_Pipeline_PHASE_D_m2_cos_lut_ROM_AUTO_1R #(
    .DataWidth( 16 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
m2_cos_lut_U(
...
module2_coarse_cfo_module2_coarse_cfo_Pipeline_PHASE_D_m2_sin_lut_ROM_AUTO_1R #(
    .DataWidth( 16 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
m2_sin_lut_U(
...
module2_coarse_cfo_mul_16s_16s_30_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 30 ))
mul_16s_16s_30_1_1_U23(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp2))) begin
        trunc_ln8_reg_538 <= {{sub_ln164_fu_383_p2[25:10]}};
        trunc_ln9_reg_543 <= {{add_ln165_fu_431_p2[25:10]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln155_reg_494_pp0_iter3_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp2) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        search_buffer_out_write = 1'b1;
    end else begin
        search_buffer_out_write = 1'b0;
    end
end
...
assign add_ln159_fu_279_p2 = (tmp_cast_fu_251_p4 + 10'd1);

assign add_ln165_fu_431_p2 = (trunc_ln165_1_fu_411_p4 + trunc_ln165_2_fu_421_p4);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2_grp1 = ((passthrough_out_full_n == 1'b0) | (data_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter4_grp2 = ((icmp_ln155_reg_494_pp0_iter3_reg == 1'd1) & (search_buffer_out_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_442 = ((icmp_ln150_fu_222_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln155_fu_231_p2 == 1'd1));
end
...
assign n_2_fu_328_p2 = (n_fu_90 + 31'd1);

assign passthrough_out_din = data_in_dout;

assign phase_acc_1_fu_307_p2 = ($signed(phase_acc_fu_94) + $signed(sext_ln138_cast_reg_485));

assign ref_tmp_i_i_0_fu_293_p3 = ((tmp_1_fu_261_p3[0:0] == 1'b1) ? select_ln159_fu_285_p3 : tmp_cast_fu_251_p4);

assign search_buffer_out_din = {{trunc_ln9_reg_543}, {trunc_ln8_reg_538}};

assign search_cnt_2_fu_312_p2 = (search_cnt_fu_98 + 32'd1);

assign select_ln159_fu_285_p3 = ((icmp_ln159_fu_273_p2[0:0] == 1'b1) ? add_ln159_fu_279_p2 : tmp_cast_fu_251_p4);
...
assign sub_ln164_fu_383_p2 = (trunc_ln164_1_fu_363_p4 - trunc_ln164_2_fu_373_p4);

assign tmp_1_fu_261_p3 = phase_acc_fu_94[32'd31];

assign tmp_cast_fu_251_p4 = {{phase_acc_fu_94[25:16]}};

assign trunc_ln150_fu_227_p1 = search_cnt_fu_98[10:0];

assign trunc_ln159_fu_269_p1 = phase_acc_fu_94[15:0];

assign trunc_ln164_1_fu_363_p4 = {{mul_ln164_fu_345_p2[29:4]}};

assign trunc_ln164_2_fu_373_p4 = {{mul_ln164_1_fu_357_p2[29:4]}};

assign trunc_ln165_1_fu_411_p4 = {{mul_ln165_fu_399_p2[29:4]}};

assign trunc_ln165_2_fu_421_p4 = {{mul_ln165_1_fu_405_p2[29:4]}};

assign zext_ln150_fu_218_p1 = n_fu_90;

assign zext_ln157_fu_245_p1 = buf_idx_fu_240_p2;

assign zext_ln160_fu_301_p1 = ref_tmp_i_i_0_fu_293_p3;

endmodule //module2_coarse_cfo_module2_coarse_cfo_Pipeline_PHASE_D
