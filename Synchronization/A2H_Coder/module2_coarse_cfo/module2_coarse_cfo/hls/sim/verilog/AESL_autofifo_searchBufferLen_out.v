...
module AESL_autofifo_searchBufferLen_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module2_coarse_cfo.autotvin_searchBufferLen_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module2_coarse_cfo.autotvout_searchBufferLen_out.dat";
