...
module AESL_autofifo_passthrough_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module2_coarse_cfo.autotvin_passthrough_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module2_coarse_cfo.autotvout_passthrough_out.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 16;
parameter DEPTH = 32'd 26105;
