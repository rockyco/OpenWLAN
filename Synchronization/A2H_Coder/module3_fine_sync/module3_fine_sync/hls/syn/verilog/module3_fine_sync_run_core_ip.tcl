create_ip -vlnv xilinx.com:ip:fir_compiler:7.2 -module_name module3_fine_sync_run_core_ip
...
] -objects [get_ips module3_fine_sync_run_core_ip]
set_property generate_synth_checkpoint false [get_files module3_fine_sync_run_core_ip.xci]
generate_target {synthesis simulation} [get_files module3_fine_sync_run_core_ip.xci]
