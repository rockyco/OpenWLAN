...
entity module3_fine_sync_run is
    generic (
...
architecture arch of module3_fine_sync_run is
    --------------------- Component ---------------------
    component module3_fine_sync_run_core_ip is
       port (
           aclk                        : in  std_logic;
           aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component module3_fine_sync_run_core_ip
    port map (
       aclk                            => ap_clk,
       aclken                          => ap_ce,
       aresetn                         => aresetn,
