...
entity system_top_fifo_w40_d2_S is 
    generic (
...
architecture rtl of system_top_fifo_w40_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component system_top_fifo_w40_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 40;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_system_top_fifo_w40_d2_S_ShiftReg : system_top_fifo_w40_d2_S_ShiftReg
    generic map (
...
entity system_top_fifo_w40_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 40;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end system_top_fifo_w40_d2_S_ShiftReg;

architecture rtl of system_top_fifo_w40_d2_S_ShiftReg is
