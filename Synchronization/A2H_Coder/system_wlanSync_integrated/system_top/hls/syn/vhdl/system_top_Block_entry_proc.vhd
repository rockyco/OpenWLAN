...
entity system_top_Block_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of system_top_Block_entry_proc is 
...
attribute shreg_extract : string;
    ...
    signal add_ln38_fu_12_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= add_ln38_fu_12_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    add_ln38_fu_12_p2 <= std_logic_vector(unsigned(num_samples) + unsigned(ap_const_lv32_FFFFFFCE));
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, add_ln38_fu_12_p2, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= add_ln38_fu_12_p2;
        else 
