...
entity system_top_consume_searchBufferLen is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of system_top_consume_searchBufferLen is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, m2_searchBufferLen_empty_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (m2_searchBufferLen_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    m2_searchBufferLen_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, m2_searchBufferLen_empty_n)
    begin
    ...
    m2_searchBufferLen_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m2_searchBufferLen_read <= ap_const_logic_1;
        else 
            m2_searchBufferLen_read <= ap_const_logic_0;
        end if; 
    end process;
