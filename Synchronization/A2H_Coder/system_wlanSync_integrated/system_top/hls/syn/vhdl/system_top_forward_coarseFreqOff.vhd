...
entity system_top_forward_coarseFreqOff is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of system_top_forward_coarseFreqOff is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, m2_coarseFreqOff_empty_n, coarseFreqOff_out_full_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (coarseFreqOff_out_full_n = ap_const_logic_0) or (m2_coarseFreqOff_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    coarseFreqOff_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, coarseFreqOff_out_full_n)
    begin
    ...
    coarseFreqOff_out_din <= m2_coarseFreqOff_dout;

    coarseFreqOff_out_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    m2_coarseFreqOff_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, m2_coarseFreqOff_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m2_coarseFreqOff_blk_n <= m2_coarseFreqOff_empty_n;
        else 
    ...
    m2_coarseFreqOff_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m2_coarseFreqOff_read <= ap_const_logic_1;
        else 
            m2_coarseFreqOff_read <= ap_const_logic_0;
        end if; 
    end process;
