...
module system_top_module4_fine_cfo_apply_Pipeline_POLL_START (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] tmp_3_i_nbreadreq_fu_74_p3;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        n_fu_64 <= 31'd0;
    end else if (((tmp_3_i_nbreadreq_fu_74_p3 == 1'd0) & (icmp_ln89_fu_160_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1_grp1 = ((icmp_ln89_reg_219 == 1'd1) & (m2_to_m4_data_empty_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

always @ (*) begin
    ap_predicate_tran3to4_state2 = ((tmp_3_i_nbreadreq_fu_74_p3 == 1'd1) & (icmp_ln89_fu_160_p2 == 1'd1));
end
...
assign m2_to_m4_startOffset_read = 1'b0;
...
assign tmp_3_i_nbreadreq_fu_74_p3 = m2_to_m4_startOffset_empty_n;

assign trunc_ln89_fu_176_p1 = n_1_reg_213[12:0];

assign trunc_ln91_fu_179_p1 = m2_to_m4_data_dout[15:0];
...
endmodule //system_top_module4_fine_cfo_apply_Pipeline_POLL_START
