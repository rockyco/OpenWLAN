...
module system_top_module4_fine_cfo_apply_Pipeline_APPLY_OVERLAP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] write_cnt_1_reload;
input  [31:0] select_ln149;
input  [12:0] empty;
...
reg   [15:0] trunc_ln197_2_reg_704;
reg    ap_block_pp0_stage0_11001_grp1;
reg   [15:0] trunc_ln198_2_reg_709;
...
wire   [25:0] trunc_ln2_fu_499_p4;
wire   [25:0] trunc_ln197_1_fu_509_p4;
...
wire   [25:0] trunc_ln3_fu_547_p4;
wire   [25:0] trunc_ln198_1_fu_557_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            reuse_reg_fu_102 <= {{m2_to_m4_data_dout[31:16]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp1))) begin
        trunc_ln197_2_reg_704 <= {{sub_ln197_fu_519_p2[25:10]}};
        trunc_ln198_2_reg_709 <= {{add_ln198_fu_567_p2[25:10]}};
    end
end
...
assign add_ln192_fu_334_p2 = (trunc_ln_fu_306_p4 + 10'd1);

assign add_ln198_fu_567_p2 = (trunc_ln3_fu_547_p4 + trunc_ln198_1_fu_557_p4);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (m2_to_m4_data_empty_n == 1'b0);
end
...
assign corrected_out_din = {{trunc_ln198_2_reg_709}, {trunc_ln197_2_reg_704}};

assign i_7_fu_282_p2 = (i_3_fu_114 + 31'd1);

assign icmp_ln184_fu_277_p2 = (($signed(zext_ln184_fu_273_p1) < $signed(select_ln149)) ? 1'b1 : 1'b0);
...
assign ref_tmp_i_i648_0_i_fu_348_p3 = ((tmp_1_fu_316_p3[0:0] == 1'b1) ? select_ln192_fu_340_p3 : trunc_ln_fu_306_p4);
...
assign select_ln192_fu_340_p3 = ((icmp_ln192_fu_328_p2[0:0] == 1'b1) ? add_ln192_fu_334_p2 : trunc_ln_fu_306_p4);
...
assign sub_ln197_fu_519_p2 = (trunc_ln2_fu_499_p4 - trunc_ln197_1_fu_509_p4);

assign tmp_1_fu_316_p3 = phase_acc_fu_106[32'd31];

assign trunc_ln184_1_fu_291_p1 = i_3_fu_114[12:0];

assign trunc_ln184_fu_380_p1 = write_cnt_fu_110[12:0];

assign trunc_ln189_fu_422_p1 = m2_to_m4_data_dout[15:0];

assign trunc_ln192_fu_324_p1 = phase_acc_fu_106[15:0];

assign trunc_ln197_1_fu_509_p4 = {{mul_ln197_1_fu_493_p2[29:4]}};

assign trunc_ln198_1_fu_557_p4 = {{mul_ln198_1_fu_541_p2[29:4]}};

assign trunc_ln2_fu_499_p4 = {{mul_ln197_fu_481_p2[29:4]}};

assign trunc_ln3_fu_547_p4 = {{mul_ln198_fu_535_p2[29:4]}};

assign trunc_ln_fu_306_p4 = {{phase_acc_fu_106[25:16]}};

assign write_cnt_3_fu_464_p2 = (write_cnt_fu_110 + 32'd1);

assign zext_ln184_fu_273_p1 = i_3_fu_114;

assign zext_ln187_fu_300_p1 = sample_idx_fu_295_p2;

assign zext_ln189_fu_438_p1 = trunc_ln184_fu_380_p1;

assign zext_ln193_fu_356_p1 = ref_tmp_i_i648_0_i_fu_348_p3;

always @ (posedge ap_clk) begin
    zext_ln187_reg_658[63:13] <= 51'b000000000000000000000000000000000000000000000000000;
end

endmodule //system_top_module4_fine_cfo_apply_Pipeline_APPLY_OVERLAP
