create_ip -vlnv xilinx.com:ip:fir_compiler:7.2 -module_name system_top_run_2_core_ip
...
] -objects [get_ips system_top_run_2_core_ip]
set_property generate_synth_checkpoint false [get_files system_top_run_2_core_ip.xci]
generate_target {synthesis simulation} [get_files system_top_run_2_core_ip.xci]
