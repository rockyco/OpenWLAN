...
`define AUTOTB_DUT      system_top
`define AUTOTB_DUT_INST AESL_inst_system_top
`define AUTOTB_TOP      apatb_system_top_top
`define AUTOTB_LAT_RESULT_FILE "system_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "system_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_system_top_top
...
`define AUTOTB_TVIN_data_in  "../tv/cdatafile/c.system_top.autotvin_data_in.dat"
`define AUTOTB_TVIN_num_samples  "../tv/cdatafile/c.system_top.autotvin_num_samples.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "../tv/rtldatafile/rtl.system_top.autotvin_data_in.dat"
`define AUTOTB_TVIN_num_samples_out_wrapc  "../tv/rtldatafile/rtl.system_top.autotvin_num_samples.dat"
`define AUTOTB_TVOUT_corrected_out  "../tv/cdatafile/c.system_top.autotvout_corrected_out.dat"
`define AUTOTB_TVOUT_coarseFreqOff_out  "../tv/cdatafile/c.system_top.autotvout_coarseFreqOff_out.dat"
`define AUTOTB_TVOUT_fineFreqOff_out  "../tv/cdatafile/c.system_top.autotvout_fineFreqOff_out.dat"
`define AUTOTB_TVOUT_corrected_out_out_wrapc  "../tv/rtldatafile/rtl.system_top.autotvout_corrected_out.dat"
`define AUTOTB_TVOUT_coarseFreqOff_out_out_wrapc  "../tv/rtldatafile/rtl.system_top.autotvout_coarseFreqOff_out.dat"
`define AUTOTB_TVOUT_fineFreqOff_out_out_wrapc  "../tv/rtldatafile/rtl.system_top.autotvout_fineFreqOff_out.dat"
module `AUTOTB_TOP;
