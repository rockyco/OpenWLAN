...
if {[file isfile system_top.autotvin.dat]} {
	file delete -force system_top.autotvin.dat
}

if {[file isfile system_top.autotvout.dat]} {
	file delete -force system_top.autotvout.dat
}
