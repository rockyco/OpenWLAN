...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.system_top.autotvin_data_in.dat"
         "c.system_top.autotvin_num_samples.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.system_top.autotvout_corrected_out.dat"
         "rtl.system_top.autotvout_coarseFreqOff_out.dat"
         "rtl.system_top.autotvout_fineFreqOff_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
