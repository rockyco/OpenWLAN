...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "system_top.autotvin.dat"
	set constFileTvOut       "system_top.autotvout.dat"
	set constFileHdlTvIn     "system_top.autohdltvin.dat"
	set constFileHdlTvOut    "system_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
