...
`define AUTOTB_DUT      module0_prefilter
`define AUTOTB_DUT_INST AESL_inst_module0_prefilter
`define AUTOTB_TOP      apatb_module0_prefilter_top
`define AUTOTB_LAT_RESULT_FILE "module0_prefilter.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "module0_prefilter.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_module0_prefilter_top
...
`define AESL_FIFO_filteredLen_out AESL_autofifo_filteredLen_out
`define AESL_FIFO_INST_filteredLen_out AESL_autofifo_inst_filteredLen_out
`define AESL_DEPTH_num_samples 1
`define AUTOTB_TVIN_data_in  "../tv/cdatafile/c.module0_prefilter.autotvin_data_in.dat"
`define AUTOTB_TVIN_num_samples  "../tv/cdatafile/c.module0_prefilter.autotvin_num_samples.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "../tv/rtldatafile/rtl.module0_prefilter.autotvin_data_in.dat"
`define AUTOTB_TVIN_num_samples_out_wrapc  "../tv/rtldatafile/rtl.module0_prefilter.autotvin_num_samples.dat"
`define AUTOTB_TVOUT_data_out  "../tv/cdatafile/c.module0_prefilter.autotvout_data_out.dat"
`define AUTOTB_TVOUT_filteredLen_out  "../tv/cdatafile/c.module0_prefilter.autotvout_filteredLen_out.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "../tv/rtldatafile/rtl.module0_prefilter.autotvout_data_out.dat"
`define AUTOTB_TVOUT_filteredLen_out_out_wrapc  "../tv/rtldatafile/rtl.module0_prefilter.autotvout_filteredLen_out.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_data_in = 26155;
parameter LENGTH_data_out = 26105;
parameter LENGTH_filteredLen_out = 1;
...
wire  data_in_read;
wire [31 : 0] data_out_din;
wire  data_out_full_n;
wire  data_out_write;
wire [15 : 0] filteredLen_out_din;
wire  filteredLen_out_full_n;
wire  filteredLen_out_write;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .data_out_din(data_out_din),
    .data_out_full_n(data_out_full_n),
    .data_out_write(data_out_write),
    .filteredLen_out_din(filteredLen_out_din),
    .filteredLen_out_full_n(filteredLen_out_full_n),
    .filteredLen_out_write(filteredLen_out_write),
...
assign    fifodata_in_ready   =   data_in_ready_reg | ready_initial;
...
assign      fifodata_out_din        =   data_out_din;
...
//------------------------FifofilteredLen_out Instantiation--------------

// The input and output of fifofilteredLen_out
wire  fifofilteredLen_out_wr;
wire  [15 : 0] fifofilteredLen_out_din;
wire  fifofilteredLen_out_full_n;
wire  fifofilteredLen_out_ready;
wire  fifofilteredLen_out_done;

`AESL_FIFO_filteredLen_out `AESL_FIFO_INST_filteredLen_out(
    .clk          (AESL_clock),
    .reset        (AESL_reset),
    .if_write     (fifofilteredLen_out_wr),
    .if_din       (fifofilteredLen_out_din),
    .if_full_n    (fifofilteredLen_out_full_n),
    .if_read      (),
    .if_dout      (),
    .if_empty_n   (),
    .ready        (fifofilteredLen_out_ready),
    .done         (fifofilteredLen_out_done)
);

// Assignment between dut and fifofilteredLen_out

// Assign input of fifofilteredLen_out
assign      fifofilteredLen_out_wr        =   filteredLen_out_write & filteredLen_out_full_n;
assign      fifofilteredLen_out_din        =   filteredLen_out_din;
assign    fifofilteredLen_out_ready   =  0;   //ready_initial | AESL_done_delay;
assign    fifofilteredLen_out_done    =   AESL_done_delay;
// Assign input of dut
reg   reg_fifofilteredLen_out_full_n;
initial begin : gen_reg_fifofilteredLen_out_full_n_process
    integer proc_rand;
    reg_fifofilteredLen_out_full_n = fifofilteredLen_out_full_n;
    while (1) begin
        @ (fifofilteredLen_out_full_n);
        reg_fifofilteredLen_out_full_n = fifofilteredLen_out_full_n;
    end
end

assign      filteredLen_out_full_n    =   reg_fifofilteredLen_out_full_n;
...
reg end_filteredLen_out;
reg [31:0] size_filteredLen_out;
reg [31:0] size_filteredLen_out_backup;
...
initial begin : proc_gen_data_in_internal_ready
    ...
    while(internal_trans_num != AUTOTB_TRANSACTION_NUM + 1) begin
        if (ap_c_n_tvin_trans_num_data_in > internal_trans_num) begin
            data_in_ready_reg <= 1;
            @(posedge AESL_clock);
            data_in_ready_reg <= 0;
...
reg dump_tvout_finish_filteredLen_out;

initial begin : dump_tvout_runtime_sign_filteredLen_out
    integer fp;
    dump_tvout_finish_filteredLen_out = 0;
    fp = $fopen(`AUTOTB_TVOUT_filteredLen_out_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_filteredLen_out_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    // last transaction is saved at negedge right after last done
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_filteredLen_out_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_filteredLen_out_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_filteredLen_out = 1;
end
