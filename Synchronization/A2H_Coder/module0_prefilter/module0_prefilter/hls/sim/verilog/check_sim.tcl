...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.module0_prefilter.autotvin_data_in.dat"
         "c.module0_prefilter.autotvin_num_samples.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.module0_prefilter.autotvout_data_out.dat"
         "rtl.module0_prefilter.autotvout_filteredLen_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
