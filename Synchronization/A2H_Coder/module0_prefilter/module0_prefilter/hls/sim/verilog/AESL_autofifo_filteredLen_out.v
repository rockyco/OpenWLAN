...
module AESL_autofifo_filteredLen_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module0_prefilter.autotvin_filteredLen_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module0_prefilter.autotvout_filteredLen_out.dat";
