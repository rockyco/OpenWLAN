...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "module0_prefilter.autotvin.dat"
	set constFileTvOut       "module0_prefilter.autotvout.dat"
	set constFileHdlTvIn     "module0_prefilter.autohdltvin.dat"
	set constFileHdlTvOut    "module0_prefilter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
