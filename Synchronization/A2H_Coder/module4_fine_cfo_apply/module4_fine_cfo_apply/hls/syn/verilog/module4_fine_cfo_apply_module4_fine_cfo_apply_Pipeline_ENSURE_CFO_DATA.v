...
module module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_ENSURE_CFO_DATA (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] write_cnt_3_out;
output   write_cnt_3_out_ap_vld;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln138_fu_146_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        write_cnt_3_out_ap_vld = 1'b1;
    end else begin
        write_cnt_3_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((icmp_ln140_reg_231 == 1'd1) & (data_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_condition_219 = ((icmp_ln140_fu_156_p2 == 1'd1) & (icmp_ln138_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
assign trunc_ln141_fu_184_p1 = data_in_dout[15:0];

assign write_cnt_2_fu_162_p2 = (ap_sig_allocacmp_n_7 + 32'd1);

assign write_cnt_3_out = write_cnt_1_fu_60;

assign zext_ln141_fu_200_p1 = trunc_ln138_reg_226;

endmodule //module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_ENSURE_CFO_DATA
