...
entity module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_POLL_START is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_POLL_START is 
...
attribute shreg_extract : string;
    ...
    signal tmp_2_nbreadreq_fu_74_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((tmp_2_nbreadreq_fu_74_p3 = ap_const_lv1_0) and (icmp_ln89_fu_160_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_block_state3_pp0_stage0_iter1_grp1_assign_proc : process(data_in_empty_n, icmp_ln89_reg_219)
    begin
                ap_block_state3_pp0_stage0_iter1_grp1 <= ((icmp_ln89_reg_219 = ap_const_lv1_1) and (data_in_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_predicate_tran3to4_state2_assign_proc : process(icmp_ln89_fu_160_p2, tmp_2_nbreadreq_fu_74_p3)
    begin
                ap_predicate_tran3to4_state2 <= ((tmp_2_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (icmp_ln89_fu_160_p2 = ap_const_lv1_1));
    end process;
    ...
    data_in_blk_n_assign_proc : process(data_in_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_grp1, icmp_ln89_reg_219)
    begin
    ...
    data_in_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln89_reg_219, ap_block_pp0_stage0_11001_grp1)
    begin
        if (((icmp_ln89_reg_219 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    tmp_2_nbreadreq_fu_74_p3 <= (0=>(startOffset_in_empty_n), others=>'-');
    trunc_ln89_fu_176_p1 <= n_1_reg_213(13 - 1 downto 0);
    trunc_ln91_fu_179_p1 <= data_in_dout(16 - 1 downto 0);
