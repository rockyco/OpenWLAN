...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.module4_fine_cfo_apply.autotvin_data_in.dat"
         "c.module4_fine_cfo_apply.autotvin_startOffset_in.dat"
         "c.module4_fine_cfo_apply.autotvin_fineOffset_in.dat"
         "c.module4_fine_cfo_apply.autotvin_num_samples.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.module4_fine_cfo_apply.autotvout_corrected_out.dat"
         "rtl.module4_fine_cfo_apply.autotvout_fineFreqOff_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
