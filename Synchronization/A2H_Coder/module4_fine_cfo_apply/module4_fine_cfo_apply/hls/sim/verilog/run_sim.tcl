...
if {[file isfile module4_fine_cfo_apply.autotvin.dat]} {
	file delete -force module4_fine_cfo_apply.autotvin.dat
}

if {[file isfile module4_fine_cfo_apply.autotvout.dat]} {
	file delete -force module4_fine_cfo_apply.autotvout.dat
}
