...
module AESL_autofifo_corrected_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module4_fine_cfo_apply.autotvin_corrected_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module4_fine_cfo_apply.autotvout_corrected_out.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 16;
parameter DEPTH = 32'd 26030;
