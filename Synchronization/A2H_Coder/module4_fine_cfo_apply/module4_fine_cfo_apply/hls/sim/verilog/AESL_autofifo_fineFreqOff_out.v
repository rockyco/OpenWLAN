...
module AESL_autofifo_fineFreqOff_out (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.module4_fine_cfo_apply.autotvin_fineFreqOff_out.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.module4_fine_cfo_apply.autotvout_fineFreqOff_out.dat";
