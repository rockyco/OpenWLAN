...
module module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_POLL_FINE (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] tmp_5_nbreadreq_fu_82_p3;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((tmp_5_nbreadreq_fu_82_p3 == 1'd0) & (icmp_ln104_fu_168_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1_grp1 = ((icmp_ln104_reg_227 == 1'd1) & (data_in_empty_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

always @ (*) begin
    ap_predicate_tran3to4_state2 = ((tmp_5_nbreadreq_fu_82_p3 == 1'd1) & (icmp_ln104_fu_168_p2 == 1'd1));
end
...
assign fineOffset_in_read = 1'b0;
...
assign tmp_5_nbreadreq_fu_82_p3 = fineOffset_in_empty_n;

assign trunc_ln104_fu_184_p1 = n_4_reg_221[12:0];

assign trunc_ln106_fu_187_p1 = data_in_dout[15:0];
...
endmodule //module4_fine_cfo_apply_module4_fine_cfo_apply_Pipeline_POLL_FINE
