; ModuleID = '/home/amd/UTS/MATLAB2HLS_SKILL_fresh/projects/wlanSync/module4_fine_cfo_apply/module4_fine_cfo_apply/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_module4_fine_cfo_apply_ir(%"class.hls::stream<complex_t, 0>"* noalias nocapture nonnull dereferenceable(4) %data_in, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %startOffset_in, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %fineOffset_in, %"class.hls::stream<complex_t, 0>"* noalias nocapture nonnull dereferenceable(4) %corrected_out, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull dereferenceable(4) %fineFreqOff_out, i32 %num_samples) local_unnamed_addr #1 {
entry:
  ...
  %fineOffset_in_copy = alloca i16, align 512
  call void @llvm.sideeffect() #9 [ "stream_interface"(i16* %fineOffset_in_copy, i32 0) ]
  %corrected_out_copy = alloca i32, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i32* %corrected_out_copy, i32 0) ]
  %fineFreqOff_out_copy = alloca i32, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i32* %fineFreqOff_out_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<complex_t, 0>"* nonnull %data_in, i32* nonnull align 512 %data_in_copy, %"class.hls::stream<ap_int<16>, 0>"* nonnull %startOffset_in, i16* nonnull align 512 %startOffset_in_copy, %"class.hls::stream<ap_int<16>, 0>"* nonnull %fineOffset_in, i16* nonnull align 512 %fineOffset_in_copy, %"class.hls::stream<complex_t, 0>"* nonnull %corrected_out, i32* nonnull align 512 %corrected_out_copy, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %fineFreqOff_out, i32* nonnull align 512 %fineFreqOff_out_copy)
  call void @apatb_module4_fine_cfo_apply_hw(i32* %data_in_copy, i16* %startOffset_in_copy, i16* %fineOffset_in_copy, i32* %corrected_out_copy, i32* %fineFreqOff_out_copy, i32 %num_samples)
  call void @copy_back(%"class.hls::stream<complex_t, 0>"* %data_in, i32* %data_in_copy, %"class.hls::stream<ap_int<16>, 0>"* %startOffset_in, i16* %startOffset_in_copy, %"class.hls::stream<ap_int<16>, 0>"* %fineOffset_in, i16* %fineOffset_in_copy, %"class.hls::stream<complex_t, 0>"* %corrected_out, i32* %corrected_out_copy, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %fineFreqOff_out, i32* %fineFreqOff_out_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<complex_t, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="4", i16* noalias nocapture align 512 "unpacked"="5.0", %"class.hls::stream<complex_t, 0>"* noalias "unpacked"="6", i32* noalias align 512 "unpacked"="7", %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="8", i32* noalias nocapture align 512 "unpacked"="9.0") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>"(i32* align 512 %1, %"class.hls::stream<complex_t, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(i16* align 512 %3, %"class.hls::stream<ap_int<16>, 0>"* %2)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(i16* align 512 %5, %"class.hls::stream<ap_int<16>, 0>"* %4)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>"(i32* align 512 %7, %"class.hls::stream<complex_t, 0>"* %6)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"(i32* align 512 %9, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %8)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<complex_t, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="4", i16* noalias nocapture align 512 "unpacked"="5.0", %"class.hls::stream<complex_t, 0>"* noalias "unpacked"="6", i32* noalias align 512 "unpacked"="7", %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="8", i32* noalias nocapture align 512 "unpacked"="9.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>.76"(%"class.hls::stream<complex_t, 0>"* %0, i32* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.57"(%"class.hls::stream<ap_int<16>, 0>"* %2, i16* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.57"(%"class.hls::stream<ap_int<16>, 0>"* %4, i16* align 512 %5)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>.76"(%"class.hls::stream<complex_t, 0>"* %6, i32* align 512 %7)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>.38"(%"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %8, i32* align 512 %9)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>.38"(%"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="0" %dst, i32* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>.41"(%"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %dst, i32* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>.41"(%"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #4 {
entry:
  %2 = alloca i32
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_int<16>, 0>.52"(i16* align 512 %dst, %"class.hls::stream<ap_int<16>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_int<16>, 0>.52"(i16* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.57"(%"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="0" %dst, i16* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_int<16>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_int<16>, 0>.60"(%"class.hls::stream<ap_int<16>, 0>"* nonnull %dst, i16* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_int<16>, 0>.60"(%"class.hls::stream<ap_int<16>, 0>"* noalias nocapture "unpacked"="0", i16* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #4 {
entry:
  %2 = alloca i16
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<complex_t, 0>.71"(i32* nonnull align 512 %dst, %"class.hls::stream<complex_t, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<complex_t, 0>.71"(i32* noalias nocapture align 512, %"class.hls::stream<complex_t, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>.76"(%"class.hls::stream<complex_t, 0>"* noalias %dst, i32* noalias align 512 %src) unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<complex_t, 0>.79"(%"class.hls::stream<complex_t, 0>"* nonnull %dst, i32* nonnull align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<complex_t, 0>.79"(%"class.hls::stream<complex_t, 0>"* noalias nocapture, i32* noalias nocapture align 512) unnamed_addr #4 {
entry:
  %2 = alloca i32
...
declare void @apatb_module4_fine_cfo_apply_hw(i32*, i16*, i16*, i32*, i32*, i32)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<complex_t, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="4", i16* noalias nocapture align 512 "unpacked"="5.0", %"class.hls::stream<complex_t, 0>"* noalias "unpacked"="6", i32* noalias align 512 "unpacked"="7", %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="8", i32* noalias nocapture align 512 "unpacked"="9.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<complex_t, 0>.76"(%"class.hls::stream<complex_t, 0>"* %0, i32* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.57"(%"class.hls::stream<ap_int<16>, 0>"* %2, i16* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.57"(%"class.hls::stream<ap_int<16>, 0>"* %4, i16* align 512 %5)
...
declare void @module4_fine_cfo_apply_hw_stub(%"class.hls::stream<complex_t, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull, %"class.hls::stream<complex_t, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull, i32)

define void @module4_fine_cfo_apply_hw_stub_wrapper(i32*, i16*, i16*, i32*, i32*, i32) #7 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<complex_t, 0>"* %7, i32* %0, %"class.hls::stream<ap_int<16>, 0>"* %9, i16* %1, %"class.hls::stream<ap_int<16>, 0>"* %11, i16* %2, %"class.hls::stream<complex_t, 0>"* %13, i32* %3, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %15, i32* %4)
  call void @module4_fine_cfo_apply_hw_stub(%"class.hls::stream<complex_t, 0>"* %7, %"class.hls::stream<ap_int<16>, 0>"* %9, %"class.hls::stream<ap_int<16>, 0>"* %11, %"class.hls::stream<complex_t, 0>"* %13, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %15, i32 %5)
  call void @copy_in(%"class.hls::stream<complex_t, 0>"* %7, i32* %0, %"class.hls::stream<ap_int<16>, 0>"* %9, i16* %1, %"class.hls::stream<ap_int<16>, 0>"* %11, i16* %2, %"class.hls::stream<complex_t, 0>"* %13, i32* %3, %"class.hls::stream<ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>, 0>"* %15, i32* %4)
  call void @free(i8* %6)
  call void @free(i8* %8)
