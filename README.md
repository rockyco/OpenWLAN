...
The A2H_Coder implementation validates against the HDL Coder reference:

| Metric | Value |
|--------|-------|
| Coarse CFO error | 2.53e-04 relative (9804.39 Hz vs 9806.86 Hz reference) |
| Fine CFO error | 9.31e-06 relative (9977.04 Hz vs 9976.95 Hz reference) |
| Waveform max error | 2.11e-02 |
| Waveform avg error | 3.31e-03 |
| Packet detection | < 1 sample error |
